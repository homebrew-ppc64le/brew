...
then
  case "$HOMEBREW_PROCESSOR" in
    ...
    armv[67]*)
      ...
      ;;
    ppc64le)
      ruby_URL="$HOMEBREW_BOTTLE_DOMAIN/bottles-portable-ruby/portable-ruby-2.6.3.ppc64le_linux.bottle.tar.gz"
      ruby_URL2="https://github.com/homebrew-ppc64le/homebrew-portable-ruby/releases/download/2.6.3/portable-ruby-2.6.3.ppc64le_linux.bottle.tar.gz"
      ruby_SHA="79158e28f216f797e2c51131d3cd395aaa984cd0df49ff1afa36d1ccb1e551a4"
      ;;
  esac
fi
